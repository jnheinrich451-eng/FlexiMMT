import os
# Note: CUDA_VISIBLE_DEVICES and HF_ENDPOINT should be set externally if needed,
# not hardcoded here, to avoid overriding caller's configuration.

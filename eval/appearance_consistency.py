...
def process_videos_in_csv_directory(csv_directory, video_directory, output_dir="eval_outputs/appearance_consistency"):
    """
    Process videos based on CSV files, compute appearance consistency for each video
    ...
    :return: List of appearance consistency scores for all videos
    """
            ...
            for row in reader:
                ...
                try:
                    ...
                    video_results.append({
                        ...
                        'appearance_consistency': avg_similarity
                    })
    ...
    with open(result_all_path, 'w', encoding='utf-8') as f:
        ...
        if all_similarities:
            ...
            f.write(f"\nOverall average cosine similarity: {overall_avg_similarity:.4f}\n")
    ...
    if video_results:
        with open(result_csv_path, 'w', newline='', encoding='utf-8') as csvfile:
            fieldnames = ['video_path', 'video_name', 'appearance_consistency']
...
output_dir = "eval_output_mask_dynamic_timestep_token_nlastframe1/appearance_consistency"
